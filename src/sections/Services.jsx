      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className={`rounded-xl overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-xl ${
                service.isAI
                  ? 'bg-slate-900 border border-blue-500/60 ring-1 ring-blue-500/20 shadow-lg shadow-blue-900/20'
                  : 'bg-slate-900 border border-gray-800 opacity-80'
              }`}
              data-aos="zoom-in"
            ...
            >
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  {service.isAI && (
                    <span className="px-2 py-0.5 text-xs font-semibold bg-blue-700 text-blue-200 rounded-full">
                      AI
                    </span>
                  )}
                </div>
